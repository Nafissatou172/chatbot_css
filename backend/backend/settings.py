...
SECRET_KEY = 'django-insecure-s!1q7eqjjww3@qtihhi12$@xf$p@#%mg17i*6a#wt8-2ocxf=o'
...
# Embeddings config: si tu veux utiliser OpenAI embeddings à la place de sentence-transformers, mets OPENAI_EMBEDDINGS=1
